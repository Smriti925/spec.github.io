...
function spec(props){
    ...
    <div className="bg-white rounded-lg shadow-2xl md:flex">
        <img src="https://4.img-dpreview.com/files/p/E~TS590x0~articles/3925134721/0266554465.jpeg" alt="alumni" className="w-96 md:w-52 rounded-t-lg md:rounded-l-lg md:rounded-t-none object-cover" />
        <div className="p-6">
